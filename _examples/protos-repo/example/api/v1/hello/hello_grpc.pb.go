...
const (
	Hello_Say_FullMethodName = "/api.v1.example.docs.Hello/Say"
)
...
func (UnimplementedHelloServer) Say(context.Context, *SayReq) (*SayResp, error) {
...
var Hello_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "protos-repo/example/api/v1/hello.proto",
}
