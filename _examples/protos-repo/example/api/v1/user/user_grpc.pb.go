...
type UserClient interface {
	...
	Create(ctx context.Context, in *UserReq, opts ...grpc.CallOption) (*common.Empty, error)
	...
	Get(ctx context.Context, in *common.ReqWithName, opts ...grpc.CallOption) (*UserInfo, error)
	...
	Update(ctx context.Context, in *UserReq, opts ...grpc.CallOption) (*common.Empty, error)
	// Del removes the user record from the persistent store and
	// synchronously purges associated entries from all cache levels.
	Del(ctx context.Context, in *common.ReqWithName, opts ...grpc.CallOption) (*common.Empty, error)
...
func (c *userClient) Create(ctx context.Context, in *UserReq, opts ...grpc.CallOption) (*common.Empty, error) {
...
func (c *userClient) Get(ctx context.Context, in *common.ReqWithName, opts ...grpc.CallOption) (*UserInfo, error) {
	out := new(UserInfo)
...
func (c *userClient) Update(ctx context.Context, in *UserReq, opts ...grpc.CallOption) (*common.Empty, error) {
	out := new(common.Empty)
...
func (c *userClient) Del(ctx context.Context, in *common.ReqWithName, opts ...grpc.CallOption) (*common.Empty, error) {
	out := new(common.Empty)
	err := c.cc.Invoke(ctx, User_Del_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) Search(ctx context.Context, in *UserSearchReq, opts ...grpc.CallOption) (*UserList, error) {
	out := new(UserList)
...
type UserServer interface {
	...
	// In Asjard, this method typically uses 'SetData' to pre-allocate IDs
	// and initialize the cache state to prevent early cache-miss storms.
	Create(context.Context, *UserReq) (*common.Empty, error)
	// Get retrieves a single user by their primary identifier (username/key).
	// Workflow: LocalCache -> Redis -> Database.
	// Failure to find a record results in a gRPC NOT_FOUND (HTTP 404).
	Get(context.Context, *common.ReqWithName) (*UserInfo, error)
	// Update modifies an existing user profile.
	// Triggers the 'Delayed Double Delete' strategy via Asjard's Time Wheel
	// to ensure consistency across distributed LocalCache nodes.
	Update(context.Context, *UserReq) (*common.Empty, error)
	// Del removes the user record from the persistent store and
	// synchronously purges associated entries from all cache levels.
	Del(context.Context, *common.ReqWithName) (*common.Empty, error)
	// Search filters users with pagination support.
	// Note: Search results are typically cached at the 'Group' level
	// with shorter TTLs compared to individual 'Get' records.
...
func (UnimplementedUserServer) Create(context.Context, *UserReq) (*common.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedUserServer) Get(context.Context, *common.ReqWithName) (*UserInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Get not implemented")
}
func (UnimplementedUserServer) Update(context.Context, *UserReq) (*common.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedUserServer) Del(context.Context, *common.ReqWithName) (*common.Empty, error) {
...
func _User_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).Get(ctx, req.(*common.ReqWithName))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _User_Del_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).Del(ctx, req.(*common.ReqWithName))
	}
	return interceptor(ctx, in, info, handler)
}
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "protos-repo/example/api/v1/user.proto",
}
