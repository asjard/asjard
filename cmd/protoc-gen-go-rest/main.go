...
func main() {
	...
	conf := openapi.Configuration{
		...
		FQSchemaNaming:  flags.Bool("fq_schema_naming", true, `schema naming convention. If "true", generates fully-qualified schema names by prefixing them with the proto message package name`),
