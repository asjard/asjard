...
type FileClient interface {
	...
	// 文件下载
	Download(ctx context.Context, in *DownloadReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *fileClient) Download(ctx context.Context, in *DownloadReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type FileServer interface {
	...
	// 文件下载
	Download(context.Context, *DownloadReq) (*emptypb.Empty, error)
...
func (UnimplementedFileServer) Download(context.Context, *DownloadReq) (*emptypb.Empty, error) {
